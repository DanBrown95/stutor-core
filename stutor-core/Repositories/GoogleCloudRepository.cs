...
{
    [Obsolete("Connections for googleCloudPlatform have been revoked and removed. Class only remains in case we go back to their platform but will require the redownload of the google.cloud.storage.v1 v3.3 package. Use the AWSS3Rpository", true)]
